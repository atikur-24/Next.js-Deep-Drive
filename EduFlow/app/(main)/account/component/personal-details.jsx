      ...
      <form onSubmit={handleUpdate}>
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
          <div>
            ...
            <Input type="text" placeholder="First Name:" id="firstName" name="firstName" value={infoState.firstName} onChange={handleChange} required />
          </div>
          <div>
            <Label className="mb-2 block">
          ...
          <div>
            ...
            <Input name="designation" id="occupation" value={infoState?.designation} type="text" onChange={handleChange} placeholder="Occupation :" />
          </div>
        </div>
        {/*end grid*/}

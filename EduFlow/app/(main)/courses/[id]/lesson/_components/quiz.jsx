      ...
      <div class="max-w-[270px] bg-white border border-border rounded-md dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-4">
          <div className="flex items-center justify-between gap-6 text-sm mb-2 font-medium text-gray-700">
            ...
            <Badge className="bg-success/20 text-primary hover:bg-success/20">{quizSet.quizIds ? quizSet.quizIds.length * 5 : 0}</Badge>
          </div>
          <p class="mb-4 font-normal text-gray-500 dark:text-gray-400 text-sm">Taking the quiz is optional but it is highly recommended.</p>
          <Button className="flex gap-2 capitalize border-sky-500 text-sky-500 hover:text-sky-500 hover:bg-sky-500/5 w-full" variant="outline" onClick={() => setOpen(true)}>
            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" class="h-4 w-4" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">

      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2  gap-6 mt-16">
          ...
          <div className="max-lg:order-2">
            ...
            {quizzes.length === 0 && <AlertBanner label="No Quiz are in the set, add some using the form above." variant="warning" className="rounded mb-6" />}
                  ...
                  <div key={quiz.id} className=" bg-gray-50 shadow-md p-4 lg:p-6 rounded-md border">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {quiz.options.map((option) => {
                        return (
                          <div className={cn("py-1.5 rounded-sm  text-sm flex items-center gap-1 text-gray-600")} key={option.label}>
                            {option.isTrue ? <CircleCheck className="size-4 text-emerald-500 " /> : <Circle className="size-4" />}

...
import { updateGoingEvent } from "@/actions";
...
const PaymentForm = ({ eventId }) => {
  ...
  return (
    <form action={() => updateGoingEvent(eventId, auth)}>
      ...
      <div className="my-4 space-y-2">
        ...
        <input type="email" id="email" className="w-full bg-[#27292F] border border-[#CCCCCC]/20 py-1 px-2 rounded-md" />
      </div>
      ...
      <div className="my-4 space-y-2">
        ...
        <input type="text" id="expiry" className="w-full bg-[#27292F] border border-[#CCCCCC]/20 py-1 px-2 rounded-md" />
      </div>

  ...
  return (
    <form className="my-8" onSubmit={onSubmit}>
      <div className="my-4 space-y-2">
        ...
        <input type="text" id="name" value={loggedInUser?.name} className="w-full border border-[#CCCCCC]/60 py-1 px-2 rounded-md" />
      </div>
      ...
      <div className="my-4 space-y-2">
        ...
        <input type="email" id="email" value={loggedInUser?.email} className="w-full border border-[#CCCCCC]/60 py-1 px-2 rounded-md" />
      </div>
